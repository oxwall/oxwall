...
class CloudStorageTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->cloudStorage = new BASE_CLASS_CloudStorage();
    }
    ...
    public function testFileUrl()
    {
        ...
        $this->assertEquals( $this->cloudStorage->getContainerUrl() . '/ow_unittest/storage/data/data/folder/testContent.txt', $url );
    }
