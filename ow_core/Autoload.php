...
class Autoload
{
    ...
    public function classToFilename( $className, $extension = true )
    {
        ...
        return substr(\Oxwall\Utilities\String::capsToDelimiter($className), 1) . ($extension ? ".php" : "");
    }
    ...
    public function filenameToClass( $fileName, $packagePointer = null )
    {
        ...
        return $packagePointer . \Oxwall\Utilities\String::delimiterToCaps("_" . substr($fileName, 0, -4));
    }
