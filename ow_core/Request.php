...
class Request
{
    ...
    public function getRequestUri()
    {
        if ( $this->uri === null )
        {
            $this->uri = \Oxwall\Utilities\Url::getRealRequestUri(\OW::getRouter()->getBaseUrl(), $_SERVER["REQUEST_URI"]);
        }
...
//    }
    ...
    {
        return Browser::getBrowser($_SERVER["HTTP_USER_AGENT"]);
    }
    ...
    {
        return Browser::getVersion($_SERVER["HTTP_USER_AGENT"]);
    }
    ...
    {
        return Browser::getPlatform($_SERVER["HTTP_USER_AGENT"]);
    }
    ...
    {
        return Browser::isMobile($_SERVER["HTTP_USER_AGENT"]);
    }
