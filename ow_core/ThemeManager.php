...
class ThemeManager
{
    ...
    public function getSelectedTheme()
    {
        ...
        {
            $this->themeObjects[$selectedTheme] = $this->themeService->getThemeObjectByKey(\OW::getConfig()->getValue("base",
                    "selectedTheme"));
        }
    ...
    public function addDecorator( $decoratorName, $pluginKey )
    {
        ...
        {
            throw new \LogicException("Cant add decorator! Decorator `{$decoratorName}` already exists!");
        }
    ...
    public function getDecorator( $decoratorName )
    {
        ...
        if ( !array_key_exists($decoratorName, $this->decorators) )
        {
            throw new \InvalidArgumentException(" Cant find decorator `{$decoratorName}` !");
        }
