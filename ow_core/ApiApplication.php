...
class ApiApplication extends Application
{
    ...
    public function init()
    {
        ...
        ErrorManager::getInstance()->setErrorOutput(new \BASE_CLASS_JsonErrOutput());

        $authToken = empty($_SERVER["HTTP_API_AUTH_TOKEN"]) ? null : $_SERVER["HTTP_API_AUTH_TOKEN"];
        Auth::getInstance()->setAuthenticator(new TokenAuthenticator($authToken));
...
//        // router init - need to set current page uri and base url
        ...
        $router->setDefaultRoute(new ApiDefaultRoute());
