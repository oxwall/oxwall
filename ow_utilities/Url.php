...
class Url
{
    ...
    public static function getRealRequestUri( $urlHome, $requestUri )
    {
        ...
        $originalUri = String::removeFirstAndLastSlashes($requestUri);
        $originalPath = String::removeFirstAndLastSlashes($urlArray["path"]);
        ...
        $uri = trim(String::removeFirstAndLastSlashes($uri));
